...
- **Simulación de mercado:** Servicio interno que actualiza automáticamente los precios de los activos  
...
3 **Compra y venta de activos**
   ...
   - Actualización automática de las posiciones y saldo del usuario

4 **Historial de transacciones**
   - Ver todas las compras y ventas realizadas
   - Filtrado por activo, tipo y fecha
